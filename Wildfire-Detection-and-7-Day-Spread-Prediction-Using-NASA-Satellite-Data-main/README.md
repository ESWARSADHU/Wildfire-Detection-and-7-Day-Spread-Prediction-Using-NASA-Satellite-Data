...
## How to Use
1. Place your NASA VIIRS/MODIS CSV files in the working directory.
2. Run the comprehensive Python script to preprocess data, train models, and visualize results.
3. View interactive and static map visualizations for spatial understanding of wildfire events.
4. Examine printed classification metrics for model performance insights.
